...
<link href="css/full-profile.css" rel="stylesheet" type="text/css" />
...
<body>
  <table width="100%" border="0">
    ...
    while ($row = $res->fetch_object()) {
      ...
      <tr>
        <td colspan="2" class="font"><?php echo ucfirst($row->firstName); ?>   <?php echo ucfirst($row->lastName); ?>'s <span
            class="font1"> Information &raquo;</span> </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2" class="heading" style="color: ;">Room Related Info &raquo; </td>
      </tr>
      <tr>
